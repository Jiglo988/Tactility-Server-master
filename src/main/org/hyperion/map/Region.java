...
public class Region {
	...
	public static void load() {
		try {
			File f = new File("./data/slash/map_index");
			...
			for(int i = 0; i < size; i++) {
				byte[] file1 = getBuffer(new File("./data/slash/map/" + mapObjectsFileIds[i] + ".dat"));
				byte[] file2 = getBuffer(new File("./data/slash/map/" + mapGroundFileIds[i] + ".dat"));
